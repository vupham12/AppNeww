package com.example.appneww.thegioi;
...
public class thegioiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_thegioi, container, false);
        WebView myWebview = myView.findViewById(R.id.webView3);
        myWebview.loadUrl("https://vnexpress.net/the-gioi");
